...
class TestUserModel:
    ...
    def test_user_role_enum_values(self, db_session):
        ...
        users = db_session.execute(select(user_model.User)).scalars().all()
        assert len(users) == 3
...
class TestDashboardModel:
    ...
    def test_dashboard_repr(self, db_session):
    ...
    def test_dashboard_str(self, db_session):
...
class TestAccessModel:
    ...
    def test_permission_enum_values(self, db_session):
    ...
    def test_access_repr(self, db_session):
...
class TestUserDashboardRelationship:
    ...
    def test_user_dashboards_relationship(self, db_session):
    ...
    def test_dashboard_users_relationship(self, db_session):
...
class TestDashboardGraphRelationship:
    ...
    def test_dashboard_graphs_relationship(self, db_session):
    ...
    def test_graph_cascade_delete(self, db_session):
...
class TestGraphModel:
    ...
    def test_create_graph(self, db_session):
        """Создание графика."""
        dashboard = dashboard_model.Dashboard(
    ...
    def test_graph_type_constraint(self, db_session):
        ...
        graphs = db_session.execute(
            select(graph_model.Graph)
        ).scalars().all()
        assert len(graphs) == 4

    def test_unique_dashboard_name_constraint(self, db_session):
    ...
    def test_graph_foreign_key_constraint(self, db_session):
    ...
    def test_graph_repr(self, db_session):
...
class TestLayoutModel:
    ...
    def test_create_layout(self, db_session):
        """Создание layout."""
    ...
    def test_create_layout_with_defaults(self, db_session):
    ...
    def test_layout_dashboards_relationship(self, db_session):
    ...
    def test_layout_cascade_delete(self, db_session):
    ...
    def test_layout_repr(self, db_session):
...
class TestAggregatedDataModel:
    ...
    def test_create_aggregated_data(self, db_session):
        ...
        db_session.add(agg_data)
        db_session.commit()
        db_session.refresh(agg_data)
    ...
    def test_aggregated_data_relationships(self, db_session):
    ...
    def test_aggregated_data_cascade_delete_dashboard(self, db_session):
        """Проверка каскадного удаления при удалении дашборда."""
        dashboard = dashboard_model.Dashboard(
    ...
    def test_aggregated_data_cascade_delete_graph(self, db_session):
...
class TestModelIndexes:
    ...
    def test_access_composite_index(self, db_session):
