...
- Соблюдать требования к планированию задач из `C:\py_dev\mkobi\.kilo\commands\plan\plan-tasks.md`
...
- `C:\py_dev\mkobi\.ai\tasks\todo\*_REJECTED.yaml`
...
- `C:\py_dev\mkobi\.ai\tasks\validation\**.md`
...
- `C:\py_dev\mkobi\.kilo\commands\plan\plan-tasks.md`
- шаблон задачи `C:\py_dev\mkobi\.ai\tasks\templates\task_template.yaml`
...
Использовать шаблон `C:\py_dev\mkobi\.ai\tasks\templates\order_template.yaml` (если доступен).
